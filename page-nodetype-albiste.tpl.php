...
<head>
  ...
  <?php print $scripts; ?>
    ...
    <?php
    $hasAlbisteSidebar = false;
    if($node->field_embeddedimages[0]['fid'] != NULL) {
      $hasAlbisteSidebar = true;
    }
    if($node->field_bideo_erlazionatuak[0]['nid'] != NULL) {
      $hasAlbisteSidebar = true;
    }
    if($node->field_erantsi[0]['fid'] != NULL) {
      $hasAlbisteSidebar = true;
    }
    ?>
<body class="<?php print $body_classes; ?> <?php print $hasAlbisteSidebar ? 'albiste_has_sidebar' : ''; ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <?php if ($breadcrumb || $title || $tabs || $help || $messages): ?>
          <div id="content-header">
            ...
            <?php endif; ?>
              <span id="albiste_eranskin_mota">
              <?php if($node->field_embeddedimages[0]['fid'] != NULL): ?>
                [.jpg]
              <?php endif; ?>
              <?php if($node->field_bideo_erlazionatuak[0]['nid'] != NULL): ?>
                [.tv]
              <?php endif; ?>
              <?php if($node->field_erantsi[0]['fid'] != NULL): ?>
                [.pdf]
              <?php endif; ?>
              </span>
              <span id="albiste_etiketak">
              <?php
              ...
              <span id="albiste_iruzkin_zenbaketa"><?php print $node->comment_count?> erantzun</span>
              <?php endif; ?>
            <?php print $messages; ?>
            <?php if ($tabs): ?>
