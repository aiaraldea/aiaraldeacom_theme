...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
    ...
    <h2 class="title" id="detail_proposamena_title">
    ...
    <div class="content" id="detail_proposamena_content">
      ...
      <div id="detail_proposamena_fitxa_teknikoa">
        <div id="detail_proposamena_fitxa_teknikoa_label">fitxa teknikoa</div>
      <?php print $node->field_fitxa_teknikoa[0]['view']; ?>
      </div>
      <div id="detail_proposamena_kolaboratzaile">
      <?php print $node->field_kolaboratzaile[0]['view']; ?>
      </div>
      <div id="detail_proposamena_audio">
      <?php print $node->field_audio[0]['view']; ?>
      </div>
      <div id="detail_proposamena_body">
